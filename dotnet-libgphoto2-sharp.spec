...
Summary(pl):	Wi您anie .NET dla libgphoto2
...
%description -l pl
Wi您anie .NET dla libgphoto2.

%package devel
Summary:	Development files for .NET binding to libgphoto2
Summary(pl):	Pliki programistyczne wi您ani .NET dla libgphoto2
...
Pliki programistyczne wi您ani .NET dla libgphoto2.
